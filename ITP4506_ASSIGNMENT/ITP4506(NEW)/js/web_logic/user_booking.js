$(document).ready(function () {
    ...
    $('#go_price').html("Business Class (Row 4-10): HKD " + go.price)
    $('#first_class_go_price').html("First Class (Row 1-3): HKD " + (go.price * 2))
    ...
    $('[id=back_price]').html("Business Class (Row 4-10): HKD " + back.price)
    $('#first_class_back_price').html("First Class (Row 1-3): HKD " + (back.price * 2))
})